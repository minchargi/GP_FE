...
<html lang="en-US">
    ...
    <body> 
        ...
        <header>
         ...
         <!-- Main Content -->
         <div class="container-fluid">
            <img src="../images/3.png" alt="bachelor image" class="responsive-image">
         </div>
         ...
         <div class="accordion">
          <div class="accordion-item">
            ...
            <div class="accordion-content">
              <ul>
                <li><a href="course-grades_index.php" class="course-link">Course Name</a></li>
                <li><a href="course-grades_index.php" class="course-link">Course Name</a></li>
                <li><a href="course-grades_index.php" class="course-link">Course Name</a></li>
                <li><a href="course-grades_index.php" class="course-link">Course Name</a></li>
                <li><a href="course-grades_index.php" class="course-link">Course Name</a></li>
                ...
                <li><a href="course-grades_index.php" class="course-link">Course Name</a></li>
                <li><a href="course-grades_index.php" class="course-link">Course Name</a></li>
                <li><a href="course-grades-gpa_index.php" class="course-link">GPA</a></li>
              </ul>
            </div>
          </div>
         </div>
