...
<html lang="en-US">
    <head> 
        ...
        <link rel="stylesheet" href="../admin/staff_depart.css">
        ...
        <div class="accordion">
          <div class="accordion-item">
            ...
            <div class="accordion-content">
              <ul>
                <li><a href="../admin/staff_trainingProgram.php">Department of Space and Applications</a></li>
                <li><a href="../admin/staff_trainingProgram.php">Department of Energy</a></li>
                <li><a href="../admin/staff_trainingProgram.php">Department of Information and Communication Technology</a></li>
                <li><a href="../admin/staff_trainingProgram.php">Department of Life Sciences</a></li>
              </ul>
            </div>
          </div>
         </div>
