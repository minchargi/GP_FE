        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addAdminsModalLabel">Create Admin</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="addAdminsForm">
                        <div class="form-group">
                            <label for="adminInfo">Admin's Name:</label>
                            <input type="text" class="form-control" id="adminInfo" required>
                        </div>
                        <div class="form-group">
                            <label for="adminInfo">Admin's Email:</label>
                            <input type="text" class="form-control" id="adminEmail" required>
                        </div>
                        <button type="button" class="btn btn-custom" onclick="addAdmin()">Add</button>
                    </form>
                </div>
            </div>
        </div>
