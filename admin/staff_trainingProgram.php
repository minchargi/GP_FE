...
<html lang="en-US">
    <head> 
        ...
        <link rel="stylesheet" href="../admin/staff_trainingProgram.css">
    ...
    <body> 
        ...
        <div class="container mt-4">
            <div class="btn-container">
              <button class="custom-button" data-bs-toggle="modal" data-bs-target="#staffTrainM">
            ...
            <!-- Add trainProg Modal-->
            <div class="modal fade" id="staffTrainM" tabindex="-1" role="dialog" aria-labelledby="staffTrainMLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staffTrainMLabel">New Training Program</h5>
            ...
            <div class="modal fade" id="importList" tabindex="-1" role="dialog" aria-labelledby="importListLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="imortListLabel">Import Staff List</h5>
                            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <!-- Form for adding new training program -->
                            <form id="importListForm" action="../admin/staffTrainM.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
            ...
            <div class="training">
                ...
                <div class="collapse" id="collapseStudent1">
                  <div class="card card-body course-card">
                    <ul class="trainMajor">
                      <li><a class="yearMajor" href="../admin/staff_List.php">Second Year</a></li>
                      <li><a class="yearMajor" href="../admin/staff_List.php">Third Year</a></li>
                    </ul>
                  </div>
                </div>
              </div>
