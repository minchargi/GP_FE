...
<html lang="en-US">
    <head> 
        ...
        <link rel="stylesheet" href="../admin/staff_traningProgram.css">
            ...
            <div class="training">
                ...
                <div class="collapse" id="collapseCourse1">
                  <div class="card card-body course-card">
                    <ul class="yearCourse">
                      <li class="courseList"><a class="courseName" href="../admin/staff_List.php">Information and Communication Technology (ICT)</a></li>
                      <li class="courseList"><a class="courseName" href="../admin/staff_List.php">Data Sciences (DS)</a></li>
                      <li class="courseList"><a class="courseName" href="../admin/staff_List.php">Cyber Security (CS)</a></li>
                    </ul>
                  </div>
                </div>
              </div>
