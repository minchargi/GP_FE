...
<html lang="en-US">
    <head> 
        ...
        <link rel="stylesheet" href="../staff/teacherDept.css">
    ...
    <body> 
        ...
        <div class="container mt-4">
          <div class="btn-container">
            <button class="custom-button" data-bs-toggle="modal" data-bs-target="#teachertM">
              <span class="button-content gap-4">
                  Add
              </span>
          </button>
          <button class="custom-button" data-bs-toggle="modal" data-bs-target="#teacherDeptM">
              <span class="button-content gap-4">
                  Add Dept
              </span>
          </button>
        ...
        <!-- Add Intake Modal -->
        <div class="modal fade" id="teachertM" tabindex="-1" role="dialog" aria-labelledby="teachertMLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="teachertMLabel">New Intake</h5>
                      ...
                      <div class="modal-body">
                          ...
                          <form id="teacherForm" action="../staff/teacherDeptM.php" method="post">
          ...
          <div class="modal fade" id="teacherDeptM" tabindex="-1" role="dialog" aria-labelledby="teacherDeptMLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="teacherDeptMLabel">Add New Intake</h5>
                          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                          </button>
                      </div>
                      <div class="modal-body">
                          <!-- Form for adding new intake -->
                          <form id="teacherDeptForm" action="../staff/studentsDeptM.php" method="post">
                              <div class="form-group">
          ...
          <div class="accordion">
            <div class="accordion-item">
              ...
              <div class="accordion-content">
                <ul>
                  <li><a href="../staff/teacherTrainManage.php">Department of Space and Applications</a></li>
                  <li><a href="../staff/teacherTrainManage.php">Department of Energy</a></li>
                  <li><a href="../staff/teacherTrainManage.php">Department of Information and Communication Technology</a></li>
                  <li><a href="../staff/teacherTrainManage.php">Department of Life Sciences</a></li>
                  <li><a href="../staff/teacherTrainManage.php">Department of Water - Environment - Oceanography</a></li>
                </ul>
              </div>
            </div>
           </div>
