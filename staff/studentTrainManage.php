...
<html lang="en-US">
    <head> 
        ...
        <link rel="stylesheet" href="../staff/studentTrainManage.css">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="studentTrainForm" action="../staff/studentTrainManageM.php" method="post" enctype="multipart/form-data">
      ...
      <div class="training">
        ...
        <div class="collapse" id="collapseStudent1">
          <div class="card card-body course-card">
            <ul class="trainMajor">
              <li><a class="yearMajor" href="../staff/studentManageList.php">Second Year</a></li>
              <li><a class="yearMajor" href="../staff/studentManageList.php">Third Year</a></li>
            </ul>
          </div>
        </div>
      </div>
