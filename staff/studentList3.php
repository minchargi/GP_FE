      ...
      <div class="container">
        <nav class="list-pagination">
            <ul class="pagination justify-content-center">
              <li class="page-item"><a class="pre-item page-link" href="../staff/studentList2.php">Previous</a></li>
              ...
              <li class="page-item active"><a class="page-link" href="../staff/studentList3.php">3</a></li>
